...
import { ExternalLink, FileText, Users, CheckCircle, Clock, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/6281234567890?text=Halo%20PASRUNA!%20Saya%20ingin%20bertanya%20tentang%20pendaftaran%20anggota%20baru."
              target="_blank"
            ...
            <a
              href="mailto:pasruna@smabarunawati.sch.id"
